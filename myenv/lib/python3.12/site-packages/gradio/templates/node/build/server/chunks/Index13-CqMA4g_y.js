...
import { B as Block, S as Static, f as BlockLabel, N as Code$2, h as Empty, j as IconButton, w as Copy$1, D as Download$1, i as IconButtonWrapper } from './2-CnaXPGyd.js';
...
const lang_map = {
  python: () => import('./index28-DTYQdMNk.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index29-Bz-067Vm.js'),
      import('./frontmatter-C6_dEAht.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => import('./index33-vDsBiKjd.js').then((m) => m.json()),
  html: () => import('./index30-DImDfxaP.js').then((m) => m.html()),
  css: () => import('./index31-CRgF67C_.js').then((m) => m.css()),
  javascript: () => import('./index32-Bg7PZeUx.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index32-Bg7PZeUx.js').then(
...
//# sourceMappingURL=Index13-CqMA4g_y.js.map
