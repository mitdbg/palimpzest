...
function create_if_block_2(ctx) {
  ...
  let t0_value = (
    /*t*/
    ((_a = ctx[33]) == null ? void 0 : _a.label) + ""
  );
  let t0;
  let t1;
  let t = (
  ...
  return {
    ...
    p(new_ctx, dirty) {
      ...
      ((_a2 = ctx[33]) == null ? void 0 : _a2.label) + ""))
...
function create_each_block_2(ctx) {
  ...
  let if_block = (
    /*t*/
    ((_a = ctx[33]) == null ? void 0 : _a.visible) && create_if_block_2(ctx)
  );
  return {
    c() {
      if (if_block)
    ...
    p(ctx2, dirty) {
      ...
      if (
        /*t*/
        (_a2 = ctx2[33]) == null ? void 0 : _a2.visible
      ) {
        if (if_block) {
...
function create_each_block_1(ctx) {
  ...
  let if_block = (
    /*t*/
    ((_a = ctx[33]) == null ? void 0 : _a.visible) && create_if_block_1(ctx)
  );
  return {
    c() {
      if (if_block)
  ...
  return {
    ...
    h() {
      ...
      toggle_class(
        ...
        "selected",
        /*t*/
        ((_a2 = ctx[33]) == null ? void 0 : _a2.id) === /*$selected_tab*/
        ctx[6]
      );
    },
    m(target, anchor) {
    ...
    p(new_ctx, dirty) {
      ...
      320) {
        toggle_class(
          ...
          "selected",
          /*t*/
          ((_b = ctx[33]) == null ? void 0 : _b.id) === /*$selected_tab*/
          ctx[6]
        );
      }
    },
...
function instance($$self, $$props, $$invalidate) {
  ...
  component_subscribe($$self, selected_tab_index, (value) => $$invalidate(23, $selected_tab_index = value));
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("selected" in $$props2)
      $$invalidate(21, selected = $$props2.selected);
    if ("initial_tabs" in $$props2)
      $$invalidate(22, initial_tabs = $$props2.initial_tabs);
    if ("$$scope" in $$props2)
  ...
  $$self.$$.update = () => {
    ...
    8) {
      $$invalidate(14, has_tabs = tabs.length > 0);
    }
    ...
    if ($$self.$$.dirty[0] & /*tabs, $selected_tab_index*/
    8388616) {
      $$invalidate(13, tab_scale = (_a2 = tabs[$selected_tab_index >= 0 ? $selected_tab_index : 0]) == null ? void 0 : _a2.scale);
    }
  };
  return [
    visible,
