...
import { c as create_ssr_component, v as validate_component, a as createEventDispatcher, e as escape, b as add_attribute, f as each, d as add_styles, h as merge_ssr_styles, o as onDestroy } from './ssr-fyTaU2Wq.js';
import { B as Block, S as Static, t as MarkdownCode, w as Copy, O as Minimize, P as Maximize } from './2-CnaXPGyd.js';
...
const Table = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = ` <div class="table-container svelte-1l6bino"><div class="header-row svelte-1l6bino">${label && label.length !== 0 && show_label ? `<div class="label svelte-1l6bino"><p class="svelte-1l6bino">${escape(label)}</p></div>` : ``} ${validate_component(Toolbar, "Toolbar").$$render(
      $$result,
      {
        show_fullscreen_button,
        is_fullscreen,
...
//# sourceMappingURL=Index56-CRBX6_QU.js.map
