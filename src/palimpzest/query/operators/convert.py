    ...
    def _create_record_set(
        ...
        record_op_stats_lst = [
            RecordOpStats(
                ...
                text_cache_read_tokens=per_record_stats.text_cache_read_tokens,
                audio_cache_read_tokens=per_record_stats.audio_cache_read_tokens,
                image_cache_read_tokens=per_record_stats.image_cache_read_tokens,
                text_cache_creation_tokens=per_record_stats.text_cache_creation_tokens,
                audio_cache_creation_tokens=per_record_stats.audio_cache_creation_tokens,
                image_cache_creation_tokens=per_record_stats.image_cache_creation_tokens,
