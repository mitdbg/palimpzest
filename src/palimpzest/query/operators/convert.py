    ...
    def _create_record_set(
        ...
        record_op_stats_lst = [
            RecordOpStats(
                ...
                total_cache_read_tokens=per_record_stats.total_cache_read_tokens,
                total_cache_creation_tokens=per_record_stats.total_cache_creation_tokens,
                total_cache_read_cost=per_record_stats.total_cache_read_cost,
                total_cache_creation_cost=per_record_stats.total_cache_creation_cost,
