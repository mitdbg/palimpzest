...
from smolagents import CodeAgent, LiteLLMModel, Tool, ToolCallingAgent, tool
...
from palimpzest.utils.mdconvert import MarkdownConverter
...
class SmolAgentsManagedSearch(PhysicalOperator):
    ...
    def __call__(self, candidate: DataRecord) -> Any:
        ...
        data_discovery_agent = ToolCallingAgent(
            model=self.model,
            tools=tools,
            max_steps=20,
            verbosity_level=2,
