...
class FilterOp(PhysicalOperator, ABC):
    ...
    def _create_record_set(
        ...
        record_op_stats = RecordOpStats(
            ...
            text_cache_read_tokens=generation_stats.text_cache_read_tokens,
            audio_cache_read_tokens=generation_stats.audio_cache_read_tokens,
            image_cache_read_tokens=generation_stats.image_cache_read_tokens,
            text_cache_creation_tokens=generation_stats.text_cache_creation_tokens,
            audio_cache_creation_tokens=generation_stats.audio_cache_creation_tokens,
            image_cache_creation_tokens=generation_stats.image_cache_creation_tokens,
