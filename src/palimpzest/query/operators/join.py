...
class LLMJoin(JoinOp):
    ...
    def _process_join_candidate_pair(
        ...
        record_op_stats = RecordOpStats(
            ...
            total_cache_read_tokens=generation_stats.total_cache_read_tokens,
            total_cache_creation_tokens=generation_stats.total_cache_creation_tokens,
            total_cache_read_cost=generation_stats.total_cache_read_cost,
            total_cache_creation_cost=generation_stats.total_cache_creation_cost,
