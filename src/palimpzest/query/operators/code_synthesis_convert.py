...
from palimpzest.constants import GPT_4o_MODEL_CARD, Model
from palimpzest.core.data.dataclasses import GenerationStats, OperatorCostEstimates
from palimpzest.datamanager.datamanager import DataDirectory
from palimpzest.query.generators.generators import CustomGenerator, code_ensemble_execution
...
class CodeSynthesisConvert(LLMConvert):
    def __init__(
        ...
        **kwargs,
        ...
        self.code_champion_generator = CustomGenerator(model=self.code_synth_model)
...
class CodeSynthesisConvertSingle(CodeSynthesisConvert):
    ...
    def _code_synth_single(
        ...
        pred, _, stats = self.code_champion_generator.generate(context=None, prompt=prompt)
