...
class OptimizerConfig(BaseModel):
    ...
    cluster_sampling_budget_allocator: Any | None = Field(default=None)
    final_operator_uncertainty_weight: float = Field(default=0.0)
    final_operator_selection_strategy: Any | None = Field(default=None)
