...
# TODO: split into start and end; for image prompts we will insert image(s) in the middle
BASE_CRITIQUE_PROMPT_START = """You are a helpful assistant tasked with critiquing the output of a model based on a given prompt.
Below is the original user prompt used to generate the output:

ORIGINAL PROMPT:
"""

BASE_CRITIQUE_PROMPT_END = """Here is the output generated by the model:
...
# TODO: split into start and end; for image prompts we will insert image(s) in the middle
BASE_REFINEMENT_PROMPT_START = """You are a helpful assistant tasked with refining the output of a model based on a critique.
Below is the original user prompt used to generate the output:

ORIGINAL PROMPT:
"""

BASE_REFINEMENT_PROMPT_END = """Here is the critique of the output:
