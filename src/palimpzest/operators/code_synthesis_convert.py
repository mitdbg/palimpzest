...
class CodeSynthesisConvert(LLMConvert):
    def __init__(
        ...
        **kwargs,
        ...
        self.code_champion_generator = CustomGenerator(model_name=self.code_synth_model.value)
    ...
    def __call__(self, candidate):
        ...
        drs = [self._create_data_record_from_json(json_obj=field_outputs, candidate=candidate, cardinality_idx=0)]
