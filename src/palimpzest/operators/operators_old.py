...
class BaseScan(LogicalOperator):
    ...
    def __str__(self):
        return (
            "BaseScan(" + str(self.outputSchema) + ", " + self.datasetIdentifier + ")"
        )
...
class LimitScan(LogicalOperator):
    ...
    def __str__(self):
        return (
            "LimitScan(" + str(self.inputSchema) + ", " + str(self.outputSchema) + ")"
        )
...
class ApplyAggregateFunction(LogicalOperator):
    ...
    def _getPhysicalTree(
        ...
        if self.aggregationFunction.funcDesc == "COUNT":
            ...
            raise Exception(
                f"Cannot find implementation for {self.aggregationFunction}"
            )
