...
Model.GPT_5_4 = Model("openai/gpt-5.4")
Model.GPT_5_4_PRO = Model("openai/responses/gpt-5.4-pro")
Model.GPT_5_4_MINI = Model("openai/gpt-5.4-mini")
Model.GPT_5_4_NANO = Model("openai/gpt-5.4-nano")
Model.GPT_5_5 = Model("openai/gpt-5.5")
Model.GPT_5_5_PRO = Model("openai/responses/gpt-5.5-pro")
Model.GPT_5_6_SOL = Model("openai/gpt-5.6-sol")
Model.GPT_5_6_TERRA = Model("openai/gpt-5.6-terra")
Model.GPT_5_6_LUNA = Model("openai/gpt-5.6-luna")
...
Model.GOOGLE_GEMINI_3_5_FLASH = Model("gemini/gemini-3.5-flash")
...
Model.GPT_AUDIO_1_5 = Model("openai/gpt-audio-1.5")
Model.GPT_AUDIO_MINI = Model("openai/gpt-audio-mini")
...
Model.AZURE_GPT_AUDIO_1_5 = Model("azure/gpt-audio-1.5")
Model.AZURE_GPT_AUDIO_MINI = Model("azure/gpt-audio-mini")
