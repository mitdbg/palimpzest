...
def assert_valid_field_type(field_type: type | types.UnionType | Field) -> str:
    """
    ...
    try:
        ...
        assert isinstance(field_type, (type, types.UnionType)), "type must be a Python type or palimpzest.core.lib.fields.Field"
    
    return "python_type"


def construct_field_type(field_type: type | types.UnionType | Field, desc: str) -> Field:
