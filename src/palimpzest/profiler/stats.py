...
class StatsProcessor:
    ...
    def _update_code_gen_stats(self, profiling_data: OperatorStats, full_code_gen_stats: FullCodeGenStats) -> OperatorStats:
        gen_stats = full_code_gen_stats.code_gen_stats
        profiling_data = self._update_gen_stats(profiling_data, gen_stats)
        profiling_data = self._update_gen_stats(profiling_data, gen_stats, code_gen_step="default")
        
        # exec_stats = full_code_gen_stats.code_exec_stats
        # """
