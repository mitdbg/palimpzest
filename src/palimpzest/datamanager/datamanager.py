...
#     def register_user_source(self, src: DataReader, dataset_id: str):
...
#         self._tempRegistry[dataset_id] = ("user", src)
    ...
    #             return ImageFileDirectoryReader(rock, dataset_id)
    ...
    #             return XLSFileDirectoryReader(rock, dataset_id)
    #         elif all([f.endswith(tuple(constants.HTML_EXTENSIONS)) for f in os.listdir(rock)]):
    #             return HTMLFileDirectoryReader(rock, dataset_id)
    #         else:
    #             return TextFileDirectoryReader(rock, dataset_id)

    #     elif entry == "file":
    #         return FileReader(rock, dataset_id)
    #     elif entry == "memory":
    #         return MemoryReader(rock, dataset_id)
    #     elif entry == "user":
    #         src = rock
    #         return src
    #     else:
...
#         return MemoryReader(cached_result, cache_id)
...
#         return path
    ...
    # def get_or_register_dataset(self, source: str | list | pd.DataFrame | DataReader):
    ...
    #     elif isinstance(source, DataReader):
    #         pass
    #     else:
