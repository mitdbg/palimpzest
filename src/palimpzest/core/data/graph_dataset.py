...
class GraphDataset(Dataset):
    ...
    def run_knn_similarity_induction(
        ...
        *,
        ...
        entry = InductionLogEntry(spec=spec, processed_node_ids=sorted(self.store.get_node_ids()))
    ...
    def run_predicate_induction(self, *, spec_id: str, mode: str = "full"):
        ...
        if not accepted_rows:
            self._induction_log.upsert(InductionLogEntry(spec=entry.spec, processed_node_ids=sorted(self.store.get_node_ids())))
            return []
