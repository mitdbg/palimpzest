...
class LogicalPlanner(Planner):
    ...
    @staticmethod
    def _compute_logical_plan_reorderings(logicalPlan: LogicalPlan) -> List[LogicalPlan]:
        """
        ...
        while op_idx < len(operators):
            ...
            elif not isinstance(op, ops.FilteredScan) and not isinstance(op, ops.ConvertScan):
                all_plans = []
            ...
            # permutation of consecutive converts and filters and recurse
                ...
                while isinstance(nextOp, ops.FilteredScan) or isinstance(nextOp, ops.ConvertScan):
