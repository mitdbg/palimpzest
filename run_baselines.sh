...
# for model in "gpt-4o" "gpt-4o-mini" "llama" "mixtral"
# do
#     python demos/fever-demo.py --verbose --workload real-estate --datasetid real-estate-eval-100 --engine nosentinel --executor sequential --policy maxquality --model $model
# done
