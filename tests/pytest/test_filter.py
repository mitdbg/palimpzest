...
def test_filter(mocker, input_schema, physical_op_class):
    ...
    proposer_models = [Model(CuratedModel.GPT_5), Model(CuratedModel.GPT_5_NANO)] if os.getenv("NO_GEMINI") else [Model(CuratedModel.GEMINI_2_5_PRO), Model(CuratedModel.GEMINI_2_0_FLASH)]
